...
import 'agregar_servicio_model.dart';
export 'agregar_servicio_model.dart';

class AgregarServicioWidget extends StatefulWidget {
  const AgregarServicioWidget({super.key});

  @override
  State<AgregarServicioWidget> createState() => _AgregarServicioWidgetState();
}

class _AgregarServicioWidgetState extends State<AgregarServicioWidget> {
  late AgregarServicioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgregarServicioModel());
    ...
    _model.txttipoServicioController ??= TextEditingController();
    _model.txttipoServicioFocusNode ??= FocusNode();
  }
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(10.0, 90.0, 0.0, 20.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    8.0, 0.0, 8.0, 0.0),
                                child: TextFormField(
                                  controller: _model.txttipoServicioController,
                                  focusNode: _model.txttipoServicioFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                  ...
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                  validator: _model
                                      .txttipoServicioControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                                ...
                                onPressed: () async {
                                  await ServiciosRecord.collection
                                      ...
                                      .set(createServiciosRecordData(
                                        ...
                                        tipoServicio: _model
                                            .txttipoServicioController.text,
                                      ));
                                  await showDialog(
                                    context: context,
