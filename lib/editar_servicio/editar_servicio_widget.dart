...
class _EditarServicioWidgetState extends State<EditarServicioWidget> {
  ...
  void initState() {
    ...
    _model.txtnombreController ??=
        TextEditingController(text: widget.servicio?.nombreServicio);
    _model.txtnombreFocusNode ??= FocusNode();

    _model.txtdescripcionController ??=
        TextEditingController(text: widget.servicio?.descripcionServicio);
    _model.txtdescripcionFocusNode ??= FocusNode();

    _model.txtcostoController ??=
        TextEditingController(text: widget.servicio?.costo?.toString());
    _model.txtcostoFocusNode ??= FocusNode();

    _model.txttipoServicioController ??=
        TextEditingController(text: widget.servicio?.tipoServicio);
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await widget.servicio!.reference
                                    ...
                                    tipoServicio:
                                        _model.txttipoServicioController.text,
                                  ));
                                  await showDialog(
                                    context: context,
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Listo'),
                                        content: Text(
                                            'Se actualizo el servicio exitosamente'),
                                        actions: [
                                          TextButton(
