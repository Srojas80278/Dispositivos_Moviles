...
import 'edit_inventario_model.dart';
export 'edit_inventario_model.dart';

class EditInventarioWidget extends StatefulWidget {
  const EditInventarioWidget({
    super.key,
  ...
  @override
  State<EditInventarioWidget> createState() => _EditInventarioWidgetState();
}

class _EditInventarioWidgetState extends State<EditInventarioWidget> {
  late EditInventarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditInventarioModel());
